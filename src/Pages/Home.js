...
const Home = () => {
  return (
    <div className="home animeLeft">
      <h1><span>SWAPI</span> | Explore o universo Star Wars</h1>
      <img src={swbanner} alt="Star Wars Banner"/>
      <p>Escolha as opções disponíveis no menu acima e visualize informações de todo o universo Star Wars.</p>
